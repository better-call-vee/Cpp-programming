...
//এইভাবে বাকি গুলো access করা যাবে। ধরুন, আপনার নোড যদি চারটা হয় তাহলে চারটা নোডের একটা অ্যারে ক্রিয়েট
// হবে(adj[4]) এবং অ্যারে এর প্রত্যেকটা ইনডেক্সে একটা করে ভেক্ট্রর রাখতে পারবেন যেখানে একটা নোড কয়টা নোডের
//সাথে কানেক্টেড সেই নোডগুলো থাকবে। this concept is called nesting in vector.
